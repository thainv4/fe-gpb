...
const updateSchema = z.object({
  ...
  mappedUsername: z
    .union([
      z
        .string()
        .min(3, "Tên đăng nhập HIS tối thiểu 3 ký tự")
        .max(100, "Tên đăng nhập HIS tối đa 100 ký tự"),
      z.literal(""),
    ])
    .optional(),
  mappedPassword: z
      ...
      >
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 border-t pt-4">
            <h4 className="col-span-2 text-md font-semibold">
              Thông tin tích hợp HIS
            </h4>
            <FormField
              control={form.control}
              name="mappedUsername"
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      type="password"
                      placeholder="Nhập mật khẩu HIS mới"
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
